...
st.title("Multiclass image classification of sporting goods retailers in France")
st.subheader("Fine-tuning ResNet-50")
st.write('This AI web app classifies from which sporting goods retailers a picture was taken')
st.markdown('Currently we have 4 classes of french sporting goods retailes : decathlon, intersport, go sport and sport 2000')
...
if img_file_buffer is not None:
    ...
    cap="Photo by Bruno Nascimento on Unsplash"
...
st.image(us_image,caption=cap, use_column_width=True,
)
